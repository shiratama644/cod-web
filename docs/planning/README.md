...
| 2 | [`HANDOFF.md`](./HANDOFF.md) | 次セッション/実装再開時 | Phase 2 実装前の注意、PLAT-2 完了状況、読んではいけない旧前提 |
...
| [`PHASE02_PLAN.md`](./PHASE02_PLAN.md) | `PLAT-2`, `PH2-A`〜`PH2-E` | PLAT-2 ローカル検証済み。次は PH2-A | Sim Profile 分離。fps 先行＋voxel は契約だけ |
...
| 優先 | ID | 内容 | 事前に読むもの |
|---:|---|---|---|
| 1 | PH2-A | `SimProfile` contract + `TYPE_SPECS` から Phase 2 実装へ進む。Phase 2 は fps 先行＋voxel は契約だけ。PH1.5 quality gate は維持する | [`HANDOFF.md`](./HANDOFF.md), [`PHASE02_PLAN.md`](./PHASE02_PLAN.md), [`../task-list.md`](../task-list.md), [`../arch/`](../arch/README.md), [`../ops/quality-gates.md`](../ops/quality-gates.md) |
