...
| [`PHASE02_PLAN.md`](./PHASE02_PLAN.md) | `PLAT-2`, `PH2-A`〜`PH2-E` | PH2-C ローカル検証済み。次は PH2-D | Sim Profile 分離。fps 先行＋voxel は契約だけ |
...
| 優先 | ID | 内容 | 事前に読むもの |
|---:|---|---|---|
| 1 | PH2-D | web `GameClient` / prediction への profile 注入へ進む。Phase 2 は fps 先行＋voxel は契約だけ。PH1.5 quality gate は維持する | [`HANDOFF.md`](./HANDOFF.md), [`PHASE02_PLAN.md`](./PHASE02_PLAN.md), [`../task-list.md`](../task-list.md), [`../arch/`](../arch/README.md), [`../ops/quality-gates.md`](../ops/quality-gates.md) |
