 ...
 */
export async function createRenderer(props: RendererFactoryProps = {}): Promise<CreatedRenderer> {
  ...
  const renderer = new WebGLRenderer({ antialias: true, canvas: props.canvas })
